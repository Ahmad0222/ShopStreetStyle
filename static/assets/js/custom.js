...
!(function (e) {
                ...
                t.on("click", "button", function () {
                    ...
                    t.on("click", "button", function () {
                        ...
                        r.isScroller(!0) && (t = r.getScrollbar()),
                            setTimeout(function () {
                                TweenLite.to(t, 1.5, { scrollTo: n.offset(), ease: Expo.easeInOut });
                            }, 500);
                    }),
    ...
    function n() {
        ...
        var a = e(".wrapper").offset(),
            ...
            l = 0;
        void 0 !== o ? (a = o) : a <= 70 && (a = s),
            r.getListener(function (e) {
                n = "scroll" === e.type ? i.scrollTop() : e.offset.y;
                let o = 70;
                void 0 !== a && (o = a - 100), n > o ? (l < n ? t.addClass("nav-bg").addClass("hide-nave") : t.removeClass("hide-nave")) : t.removeClass("nav-bg").removeClass("hide-nave"), (l = n);
            });
    }
    function a() {
